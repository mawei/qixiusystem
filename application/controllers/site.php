...
class Site extends CI_Controller {
	...
	public function profile(){
		...
		$insurances['ID_back_image'] = base_url('assets/uploads/files/' . $insurances['ID_back_image']);
		$insurances['bank_image'] = base_url('assets/uploads/files/' . $insurances['bank_image']);
	...
	public function workerlist(){
		...
		$this->data['workerlist'] = $records;
		$this->parser->parse('front/workerlist',$this->data);
	}
